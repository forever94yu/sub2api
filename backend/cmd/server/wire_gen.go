...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	dashboardHandler := handler.ProvideAdminDashboardHandler(dashboardService, dashboardAggregationService, opsService)
	...
	channelMonitorQuotaFetcher := service.NewChannelMonitorQuotaFetcher(accountUsageService, accountRepository)
