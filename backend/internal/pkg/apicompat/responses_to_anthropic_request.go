...
func convertResponsesInputToAnthropic(instructions string, inputRaw json.RawMessage, preserveThinkingOption ...bool) (json.RawMessage, []AnthropicMessage, error) {
	preserveThinking := len(preserveThinkingOption) > 0 && preserveThinkingOption[0]
