...
func (c *gatewayCache) SaveLiveCall(ctx context.Context, record *service.LiveCallRecord, ttl time.Duration) error {
	...
	if record.AccountRateMultiplier != nil {
		values["account_rate_multiplier"] = *record.AccountRateMultiplier
	}
	if record.RateMultiplier != nil {
		values["rate_multiplier"] = *record.RateMultiplier
	}
...
func (c *gatewayCache) GetLiveCall(ctx context.Context, callHash string) (*service.LiveCallRecord, error) {
	...
	return &service.LiveCallRecord{
		...
		RateMultiplier:           parseFloatPtr("rate_multiplier"),
		AudioRealtimePricePerMin: parseFloatPtr("audio_realtime_price_per_min"),
