...
func (r *liveTestBillingRepo) Apply(_ context.Context, cmd *UsageBillingCommand) (*UsageBillingApplyResult, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
	copy := *cmd
...
func (r *liveTestBillingRepo) ReserveBatchImageBalance(context.Context, *BatchImageBalanceHoldCommand) (*BatchImageBalanceHoldResult, error) {
	return nil, errors.New("unexpected ReserveBatchImageBalance call")
}

func (r *liveTestBillingRepo) CaptureBatchImageBalance(context.Context, *BatchImageBalanceHoldCommand) (*BatchImageBalanceHoldResult, error) {
	return nil, errors.New("unexpected CaptureBatchImageBalance call")
}

func (r *liveTestBillingRepo) ReleaseBatchImageBalance(context.Context, *BatchImageBalanceHoldCommand) (*BatchImageBalanceHoldResult, error) {
	return nil, errors.New("unexpected ReleaseBatchImageBalance call")
}
...
func TestFinalizeLiveCallIsIdempotentAndBillsRealtimeUsage(t *testing.T) {
	...
	require.InDelta(t, 0.10, log.TotalCost, 0.01)
	require.InDelta(t, log.TotalCost, log.ActualCost, 0.000001)
	...
	require.Equal(t, record.AccountID, cmd.AccountID)
