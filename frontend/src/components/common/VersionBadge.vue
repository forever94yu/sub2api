...
const GITHUB_REPO = 'forever94yu/sub2api'
// Docker Hub image published by CI (tags carry no "v" prefix, e.g. forever94yu/sub2api:0.1.146)
const DOCKER_IMAGE = 'forever94yu/sub2api'
