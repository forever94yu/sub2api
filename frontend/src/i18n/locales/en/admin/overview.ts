export default {
    ...
    groups: {
      ...
      compositeRoutes: {
        ...
        upstreamModelHint: 'Leave empty to pass the original requested model through: under prefix match each matched model forwards verbatim (e.g. vendor-v4-flash and vendor-v4-pro each forwarded as-is); set a value to forward every matched request to that fixed model.',
        notes: 'Notes',
        enabled: 'Enabled',
        preview: 'Preview',
        matched: 'Matched',
