...
curl -sSL https://raw.githubusercontent.com/forever94yu/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/forever94yu/sub2api/releases)
