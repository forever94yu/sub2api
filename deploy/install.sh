...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/forever94yu/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="forever94yu/sub2api"
...
Documentation=https://github.com/forever94yu/sub2api
